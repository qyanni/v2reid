...
class CenterLoss(nn.Module):
    ...
    def __init__(self, num_classes=751, feat_dim=2048, use_gpu=True, device='cuda:0'):
    ...
    def forward(self, x, labels):
        ...
        distmat.addmm_(x, self.centers.t(), beta=1, alpha=-2)   #https://github.com/KaiyangZhou/pytorch-center-loss/issues/16
