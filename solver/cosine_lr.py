...
class CosineLRScheduler(Scheduler):
    ...
    t_initial : `int`
        The number of iterations (epochs) within the first cycle/ The initial number of epochs. Example, 50, 100 etc
    cycle_mul : `float`, optional (default=`1`)
    ...
    lr_min : `float`, optional (default=`0`)
        The minimum learning rate to use during the scheduling
    cycle_decay : `float`, optional (default=`1`)
